package uni9.projetopraticoemsistemas.myhealth.home.bulas.view;
...
import uni9.projetopraticoemsistemas.myhealth.home.bulas.viewmodel.BuscaMedicamentoViewModel;
...
import uni9.projetopraticoemsistemas.myhealth.home.lembretes.adapters.MedicamentoAdapter;
        ...
        viewModel.getMedicamentoLiveData().observe(getViewLifecycleOwner(),
                medicamento -> {
                    if (!Objects.isNull(medicamento)) {
                        Navigation.findNavController(requireView()).navigate(BuscaMedicamentosFragmentDirections.actionBulaBuscaMedicamentoFragmentToBulaMedicamentoFragment(medicamento.getId(), medicamento.getProcesso()));
                    }
                });
